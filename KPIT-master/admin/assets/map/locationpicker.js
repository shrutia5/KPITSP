        ...
        address_component_from_google_geocode: function(address_components) {
            ...
            for (var i = address_components.length - 1; i >= 0; i--) {
                ...
                if (component.types.indexOf("postal_code") >= 0) {
                    result.postalCodeShort = component.short_name;
                    result.postalCode = component.long_name;
                } else if (component.types.indexOf("street_number") >= 0) {
                    result.streetNumberShort = component.short_name;
                    result.streetNumber = component.long_name;
                } else if (component.types.indexOf("route") >= 0) {
                    result.streetNameShort = component.short_name;
                    result.streetName = component.long_name;
                } else if (component.types.indexOf("locality") >= 0) {
                    result.cityShort = component.short_name;
                    result.city = component.long_name;
                } else if (component.types.indexOf("sublocality") >= 0) {
                    result.districtShort = component.short_name;
                    result.district = component.long_name;
                } else if (component.types.indexOf("administrative_area_level_1") >= 0) {
                    result.stateOrProvinceShort = component.short_name;
