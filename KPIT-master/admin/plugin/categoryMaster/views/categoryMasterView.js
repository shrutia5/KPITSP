...
define([
  ...
  'backbone',
  'datepicker',
  '../views/categoryMasterSingleView',
  '../collections/categoryMasterCollection',
  '../models/categoryMasterFilterOptionModel',
  'text!../templates/categoryMasterRow.html',
  'text!../templates/categoryMasterTemp.html',
  'text!../templates/categoryMasterFilterOptionTemp.html',
], function($,_, Backbone,datepicker,categoryMasterSingleView,categoryMasterCollection,categoryMasterFilterOptionModel,categoryMasterRowTemp,categoryMasterTemp,categoryMasterFilterTemp){
...
var categoryMasterView = Backbone.View.extend({
    ...
    initialize: function(options){
        ...
        filterOption = new categoryMasterFilterOptionModel();
        searchcategoryMaster = new categoryMasterCollection();
    ...
    changeStatusListElement:function(e){
      ...
      $('#categoryMasterList input:checkbox').each(function(){
          if($(this).is(":checked"))
          {
            removeIds.push($(this).attr("data-categoryID"));
          }
      });
    ...
    loadSubView:function(e){
        ...
        switch(show)
        {
          case "singlecategoryMasterData":{
            var categoryID = $(e.currentTarget).attr("data-categoryID");
            var categoryMasterSingleview = new categoryMasterSingleView({categoryID:categoryID,searchcategoryMaster:this});
            break;
          }
        }
    },
    ...
    addOne: function(objectModel){
        var template = _.template(categoryMasterRowTemp);
        $("#categoryMasterList").append(template({categoryMasterDetails:objectModel}));
    },
    addAll: function(){
        $("#categoryMasterList").empty();
    ...
    render: function(){
        var template = _.template(categoryMasterTemp);
