define([
  ...
  'text!../templates/trlQuestionsSingleTemp.html',
], function($,_, Backbone,validate,inputmask,datepicker,trlQuestionsSingleModel,trlQuestionsTemp){

var trlQuestionsView = Backbone.View.extend({
    model:trlQuestionsSingleModel,
    initialize: function(options){
        //alert("here");
        var selfobj = this;
        $(".modelbox").hide();
        scanDetails = options.searchtrlQuestions;
        $('#faqData').remove();
        $(".popupLoader").show();
