    ...
    <div class="container-fluid p-0">
        <div class="row m-0">
            ...
            <div class="col-md-7  register-right">
                ...
                <form id="menUpdatePassword" action="<?php echo base_url();?>mentor/updatepassword" class="center-data-section d-md-flex align-items-center" method="POST" autocomplete="off">
                     <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-12 offset-md-2">
                                ...
                                <div class="row form-row ws-form-row m-0">
                                    <div class="col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="men-condition" style="padding-bottom: 30px;">
                                            <input class="form-check-input" type="checkbox" name="menNDA" id="menNDA" value="1" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 col-sm-12 col-12form-group">
                                                <input type="submit" name="menreset" id="menreset" value="UPDATE"/>
