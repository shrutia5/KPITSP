            ...
            <div class="col-md-12 project">
                <div class="full-left noFooter">
                    ...
                    <ul class="nav nav-tabs nav-tabs-c" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="evaluatorsAction-tab" data-toggle="tab" href="#evaluatorsAction" role="tab" aria-controls="evaluatorsAction" aria-selected="true">Evaluator’s Action</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="project-tab" data-toggle="tab" href="#project" role="tab" aria-controls="project" aria-selected="true">Project Details</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="evaluatorsAction" role="tabpanel" aria-labelledby="evaluatorsAction-tab">
