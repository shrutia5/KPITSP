    ...
    <div class="container-fluid p-0">
        <div class="row m-0">
            ...
            <div class="col-md-7  register-right">
                ...
                <form id="incuUpdatePassword" action="<?php echo base_url();?>incubate/UpdatePassword" class="center-data-section d-md-flex align-items-center" method="POST" autocomplete="off">
                     <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-12 offset-md-2">
                                ...
                                <div class="row form-row ws-form-row m-0">
                                    <div class="col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="incu-condition">
                                        <input class="form-check-input" type="checkbox" name="incuNDA" id="incuNDA" value="1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 col-sm-12 col-12 form-group">
                                                <input type="submit" name="incureset" class="incureset" id="incureset" value="UPDATE"/>
