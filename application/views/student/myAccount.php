<main id="portal">
    ...
    <div class="container-fluid p-0">
            ...
            <div class="col-md-3 pt-4 helpful-section noFooter">
                <div class="div-cla" style="text-align: center; border-bottom: 1px solid #C8C8C8; margin-bottom: 2rem;">
                    ...
                    <div class="row form-row ws-form-row m-0" style="display: block !important;">
                        ...
                        <form id="updateresources" action="<?php echo base_url();?>updateResourcesProfile" method="post">
                            ...
                            <div class="col-md-4 form-group">
                                            <input type="submit" name="updatereso" class="userNav eduDetails" href="#" data-act="section" data-url="eduDetails" id="updatereso" value="UPDATE"/>
                            </div>
                        </form> 
                </div> 
                </form> 
                ...
                <div class="full-left noFooter">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="EducationalDetails" role="tabpanel" aria-labelledby="EducationalDetails-tab">
                            <div class="tab-body">
                            <form id="updateEduProfile" class="dask-updateEduProfile" action="<?php echo base_url();?>updateEducationalProfile" enctype="multipart/form-data" method="post">
                                <div class="row p-4">
                                    <input type="hidden" value="<?php echo $userData->userID ?>" name="userid" id="userid">
                                    <div class="col-md-4 form-group">
                                        <label>State*</label>
                          ...
                          <div class="tab-pane fade" id="ReferenceDetail" role="tabpanel" aria-labelledby="ReferenceDetails-tab">
                            <div class="tab-body">
                            <form id="updateRefProfile"  action="<?php echo base_url();?>updateReferenceProfile" method="post" autocomplete="off" onsubmit="return false;">
        ...
        <div id="mobileView" class="row m-0">
            <div class="full-left noFooter mobile-profile">
                <ul class="nav nav-tabs nav-tabs-c" id="myTab" role="tablist">
                    <li class="nav-item nav1">
                        <a class="nav-link active nav-txt" id="profileM-tab" data-toggle="tab" href="#ProfileDetailsM" role="tab" aria-controls="ProfileDetailsM" aria-selected="true">Profile</a>
                    </li>
                    <li class="nav-item nav1">
                        <a class="nav-link nav-txt" id="EducationalDetailsM-tab" data-toggle="tab" href="#EducationalDetailsM" role="tab" aria-controls="EducationalDetailsM" aria-selected="false">Educational</a>
                    </li>
                    <li class="nav-item nav1">
                        <a class="nav-link nav-txt" id="ReferenceDetailM-tab" data-toggle="tab" href="#ReferenceDetailM" role="tab" aria-controls="ReferenceDetailsM" aria-selected="false">Reference</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent1">
                    <div class="tab-pane fade show active" id="ProfileDetailsM" role="tabpanel" aria-labelledby="ProfileDetailsM-tab">
                        <div class="tab-body">
                            <div class="div-cla" style="text-align: center; border-bottom: 1px solid #C8C8C8; margin-bottom: 2rem;">
                                <div class="profile-img">
                                    <div class="slim mx-auto"
                                    data-label="Drop your avatar here"
                                    data-service="Myaccount/SetprofilePic"
                                    data-ratio="1:1" style="border-radius: 50%; width: 140px; height: 140px;">
                                        <?php 
                                        //echo $userData->profilePic;exit;
                                        if($userData->profilePic != ""){ ?> 
                                            <img class="pro-img img-fluid" src="<?php echo base_url();?>uploads/profile_pic/<?php echo $userData->profilePic; ?>">
                    ...
                    <div class="tab-pane fade" id="EducationalDetailsM" role="tabpanel" aria-labelledby="EducationalDetailsM-tab">
                        <div class="tab-body">
                            <form id="updateEduProfileMobile"  action="<?php echo base_url();?>updateEducationalProfile" enctype="multipart/form-data" method="post">
                            <input type="hidden" value="<?php echo $userData->userID ?>" name="userid" id="userid">
                                <div class="row p-4">
                                   
                                    <div class="col-md-4 form-group">
                                        <label>State*</label>
                                        <select class="form-control dulState" name="state">
                                    ...
                                    <div class="validate"></div>
                                        ...
                                        <?php foreach ($userCollege as $key => $ucollege) {?>
                                            <option <?php if($ucollege->college_id == $userData->college_id){ echo "selected";}?> value="<?php echo $ucollege->college_id; ?>"><?php echo $ucollege->college_name; ?></option>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <?php foreach ($userCity as $key => $ucity) {?>
                                            <option <?php if($ucity->city_id ==$userData->city_id){ echo "selected";} ?> value="<?php echo $ucity->city_id; ?>"><?php echo $ucity->city_name; ?></option>
                                ...
                                <div class="row p-4">
                                    <div class="col-md-12">
                                        ...
                                        <div class="cla-img">
                                            <label>College Identity Card*</label>
                                            <p><?php echo $userData->identityCard;?></P>
                                            <p>Upload a scanned copy of your college/university identity card picture.</P>
                                            
                                            <input id="upload" type="file"  name="id_img"/>
                                            <div class="id-img">
                                                <span>drag and drop your file here OR</span>
                                                <a href="id_img" name="id_img" id="upload_link" class="clg-icard">UPLOAD HERE</a>
                                            </div>
                                            <p>Allowed formats are .png .jpeg and .pdf</p>
                                        </div>
                                    </div>
                                ...
                                <div class="row p-4">
                                    <div class="col-md-4 form-group">
                                        <input type="submit" name="saveuser" class="userNav eduDetails" data-act="section" data-url="eduDetails" id="saveuser" value="UPDATE"/>
                                    </div>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="ReferenceDetailM" role="tabpanel" aria-labelledby="ReferenceDetailsM-tab">
                        <div class="tab-body">
                        <form id="updateRefProfile"  action="<?php echo base_url();?>updateReferenceProfile" method="post">
                        <h5>Please Fill in details of 2 references from your College...</h5>
                        <h5>Reference 1</h5>
                        <input type="hidden" value="<?php echo $userData->userID ?>" name="userid" id="userid">
                            <div class="row p-4 ref">
                                <div class="col-md-4 form-group">
                                    <label>First Name*</label>
                                    <input type="text" class="form-control" value="<?php echo $userData->ref1FirstName ?>" name="ref1_fname" id="ref1_fname">
                                    
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Last Name*</label>
                                    <input type="text" class="form-control" value="<?php echo $userData->ref1LastName ?>" name="ref1_lname" id="ref1_lname">
                                </div>
                                <div class="col-md-4 form-group email-txt1">
                                    <label>Email ID*</label>
                                    <input type="email" class="form-control" value="<?php echo $userData->ref1Email ?>" name="ref1_email" id="ref1_email">
                                </div>
                            </div>
                            <div class="row p-4  ref">
                                <div class="col-md-4 form-group">
                            ...
                            <div class="row p-4 ref">
                                <div class="col-md-4 form-group">
                                    <label>First Name*</label>
                                    <input type="text" class="form-control" value="<?php echo $userData->ref2FirstName ?>" name="ref2_fname" id="ref2_fname">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Last Name*</label>
                                    <input type="text" class="form-control" value="<?php echo $userData->ref2LastName ?>" name="ref2_lname" id="ref2_lname">
                                </div>
                                <div class="col-md-4 form-group email-txt1">
                                    <label>Email ID*</label>
                                    <input type="email" class="form-control" value="<?php echo $userData->ref2Email ?>" name="ref2_email" id="ref2_email">
                                </div>
                            </div>
                            <div class="row p-4 ref">
                                <div class="col-md-4 form-group">
                                    <label>Personal Contact No.*</label>
                                    <input type="text" class="form-control" value="<?php echo $userData->ref2ContactNo ?>" name="ref2_phone"  pattern="[6789][0-9]{9}" title="Please Enter valid Mobile Number" id="ref2_phone">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Designation*</label>
                                    <input type="text" class="form-control" value="<?php echo $userData->ref2Designation ?>" name="ref2_designation" id="ref2_designation">
