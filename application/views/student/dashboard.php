                        ...
                        <div class="card" style="width: 25rem;">
                            <div class="card-body">
                                ...
                                <div class="card-text">
                                    ...
                                    <?php } ?>
                                    <span class="ayesTop100 hide<?php if($adminData1->shareWithIncubator != ''){echo '-false';} ?>">You have opted <span class="incubation-status"><?php if($adminData1->shareWithIncubator == 'No'){echo 'not ';} ?></span> to share your project data with our incubation partners.We consider this as the collective preference of your entire team.</span>
                                </div>
                            </div>
                        </div>
                            <?php  } ?>
                ...
                <div class="row default-view no-border">
                    <div class="default-view-my-project default-view-invited">
                        ...
                        <div class="mt-4 view3">
                            <?php if($adminData1->projectStatus!="Reject" && $adminData1->phaseTwoStatus!="Reject" && $adminData1->phaseThreeStatus!="Reject"){
                ...
                <div class="row green2">
                    ...
                    <div class="col-md-6 green-power1">
                        <div class="default-view-invited">
                            ...
                            <div class="pro-team mt-4">
                                <span class="small normal tt1">Team Members</span>
                                <p class="light"><?php echo ucfirst($teamProjects[0]->firstname);
                ...
                <div class="row">
                    <div class="col-md-6 green-power1">
                        <div class="default-view-my-project default-view-invited">
                            ...
                            <div class="pro-team mt-4">
                                <span class="small normal tt1">Team Members</span>
                                <p class="light"><?php echo  $this->session->userdata('name');
                                $teamMembers = $this->CommonModel->getProjectMembers($adminData1->projectID);
                                if($teamMembers != "-"){
                                    echo " , ".ucfirst($teamMembers);
                                }
                    ...
                    <div class="col-md-6 green-power1">
                        <div class="default-view-invited">
                            ...
                            <div class="pro-team mt-4">
                                <span class="small normal tt1">Team Members</span>
                                <p class="light"><?php echo $teamProjects[0]->firstname;
                                $teamMembers = $this->CommonModel->getProjectMembers($teamProjects[0]->projectID);
                                if($teamMembers != "-"){
                                    echo " , ".$teamMembers;
                                }
                ...
                <?php if(count($teamProjects) >= 2 ){ 
                    ...
                    <div class="col-md-6 mt-5 green-power3">
                        <div class="default-view-invited ">
                            ...
                            <div class="pro-team mt-4">
                                <span class="small normal tt1">Team Members</span>
                                <p class="light"><?php echo ucfirst($teamProject->firstname);
