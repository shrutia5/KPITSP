    ...
    <div class="container-fluid p-0">
        <div class="row m-0">
            ...
            <div class="col-md-7 register-right">
                ...
                <form id="personalbankdetails" action="<?php echo base_url();?>" class="center-data-section d-md-flex align-items-center" method="POST" autocomplete="off">
                    <div class="register-form process-section home personal-bank-details">
