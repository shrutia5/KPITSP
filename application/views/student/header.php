...
<head>
  ...
  <title>
    <?php if(isset($pageTitle)){echo  $pageTitle;}else{ echo "kpit"; }  ?>
  </title>
            ...
            <span class="myaccount">
              ...
              <div class="my-pro" id="menu">
                <span>
                  ...
                  <img class="pro-img img-fluid"
                    src="<?php echo base_url();?>uploads/profile_pic/<?php echo $profile_img; ?>">
                  <?php  }else{
                                          echo "no";
                                        }
                                      ?>
                </span><span class="wename">
                  <?php echo "Welcome ". ' '.$this->session->userdata('name');?>
                </span>
                <i class='bx bxs-chevron-down' id="togglemenu"></i>
              </div>
              <div class="sub-myaccount">
                <p><a href="<?php echo base_url()?>student/dashboard" class="d-block dashboard0 make-active">My
                    Dashboard</a></p>
                <p><a href="<?php echo base_url()?>student/myaccount" class="d-block myaccount0 make-active">My
                    Profile</a></p>
                <p class="no-display"><a href="<?php echo base_url()?>helpful-resources" class="d-block kpit0 make-active">Helpful
                    Resources</a></p>
