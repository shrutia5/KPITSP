                        ...
                        <div class="row form-row ws-form-row m-0">
                            <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-6 form-group otherClgList hide">
                                    ...
                                    <!-- <input type="hidden" class="form-control" name="city" id="city" placeholder="Enter your college name"> -->
                                </div>
                                ...
                                <!-- <label class="fb-icon">State*</label>
                                <input type="text" class="form-control" name="state" id="state" placeholder="copy paste URL"> -->
                               
                            <div class="col-md-6 form-group clgcity">
                                <!-- <label class="fb-icon">City*</label>
                                <input type="text" class="form-control" name="City" id="City" placeholder="Enter your name"> -->
                                <label>City*</label>
                                <!-- <select class="form-control changeCity" data-action="<?php base_url(); ?>getCollegelist" name="city" id="cityList">
                            ...
                            <!-- <div class="col-md-6 form-group">
                            <label>Select College*</label>
                                <select class="form-control changecollege" data-action="<?php base_url(); ?>" name="college" id="collegeList">
                                    <option value="">Select college</option>
                                </select>
                                <div class="validate"></div>
                            </div> -->
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" name="degree" id="degree" placeholder="Enter your Password">
                                <div class="validate"></div> -->
                                <label class="fb-icon">Degree*</label>
