    ...
    <div class="container-fluid p-0">
        <div class="row m-0">
            ...
            <div class="col-md-7  register-right">
                ...
                <form id="login" action="<?php echo base_url(); ?>evaluator/resetpassword" class="center-data-section d-md-flex align-items-center" method="POST" autocomplete="off">
                    <div class="container">
                        <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="row">
                                            <div class="col-md-10 col-12 form-group">
                                                ...
                                                <input type="text" class="form-control log-txt log-txt5" name="userEmail" id="userEmail" placeholder="Enter email">
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row eval-login">
                                            <div class="col-md-6 col-12 form-group">
                                                <input type="submit" name="loginSubmit" class="userNaveduDetails" data-act="section" data-url="" id="loginSubmit" value="RESET"/>
                                                <a href="" class="eva_cancel" style="padding-left: 20px;">CANCEL</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
