...
<head>
  ...
  <link href="<?php echo base_url();?>css/mobile-evalutor.css" rel="stylesheet">
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid p-0">
      <div class="row justify-content-center">
        <div class="col-xl-12 d-flex align-items-center eva-header">
          <a href="<?php echo base_url();?>" class="logo">
            <img src="<?php echo base_url();?>images/logo.png" alt="KPIT SPARKLE">
          </a>
          <nav class="nav-menu d-none d-lg-block m-auto" id="eva-headBar">
            <ul>
              <li <?php if(isset($menuName) &&!empty($menuName)){ if($menuName =="home"){ echo 'class="active"'; } }?> ><a  href="<?php echo base_url();?>evaluator/dashboard">Home</a></li>
              <li <?php if(isset($menuName) &&!empty($menuName)){ if($menuName =="inbox"){ echo 'class="active"'; } }?>><a href="<?php echo base_url();?>evaluator/inbox">Inbox</a></li>
              <li <?php if(isset($menuName) &&!empty($menuName)){ if($menuName =="summary"){ echo 'class="active"'; } }?> ><a href="<?php echo base_url();?>evaluator/summary">Summary</a></li>
              <li <?php if(isset($menuName) &&!empty($menuName)){ if($menuName =="help"){ echo 'class="active"'; } }?> ><a  href="<?php echo base_url();?>evaluator/help">Help</a></li>
            </ul>
          </nav><!-- .nav-menu -->
        ...
        <?php if($this->session->userdata('userId'))
          { ?>
           ...
           <p><a href="<?php echo base_url()?>evaluator/dashboard" class="d-block dashboard0 make-active">My Dashboard</a></p>
            ...
            <p><a href="<?php echo base_url()?>" class="d-block kpit0 make-active">Helpful Resources</a></p> -->
