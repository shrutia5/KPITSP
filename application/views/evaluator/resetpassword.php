                            ...
                            <div class="col-md-8 col-12 offset-md-2">
                                ...
                                <div class="row form-row ws-form-row m-0">
                                    <div class="col-md-12 col-sm-12 col-12">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="termAndCon" id="termAndCon" value="1" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 col-sm-12 col-12form-group">
                                                <input type="submit" name="saveuser" class="userNav eduDetails" href="#" data-act="section" data-url="eduDetails" id="saveuser" value="UPDATE"/>
