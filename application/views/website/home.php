...
<section class="services section-bg">
  <div class="container" data-aos="fade-up">
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-6 pl-0"> <!-- platforms home-crack -->
            <!-- <iframe 
                src="https://www.youtube.com/embed/PQHkD0QIKZI" style="width:100%;height:100%;border:none;">
            </iframe>
            -->
    ...
    <a href="#myModal" class="play-video"  data-toggle="modal">
        <img src="<?php echo base_url()?>images/kpits.jpg" alt=""><i style="position: relative; top:-254px; left:172px; font-size:50px" class='bx bx-play-circle'></i>
    </a>
