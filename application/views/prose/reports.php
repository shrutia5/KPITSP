        ...
        <div class="row m-0 admin-height">
            <div class="col-md-9 mobile-changes1">
                <div class="helpful-section noFooter">
                    <form id="reportFilter" action="<?php echo base_url('prose/reports');?>" method="get">
                    ...
                    switch ($filterType) {
                        case 'state_wise':
                            $this->load->view('prose/all_report',$otherPage);
                        break;
                        case 'city_wise':
                            $this->load->view('prose/all_report',$otherPage);
                        break;
                        ...
                        break;
                        case 'list_of_reg':
                            $this->load->view('prose/register_report',$otherPage);
                            break;
                        case 'all_report':
                            $this->load->view('prose/all_report',$otherPage);
                        break;
                        ...
                        break;
                        case 'gender_wise':
                            $this->load->view('prose/genderReport',$otherPage);
                        break;
                        case 'week_wise':
                            $this->load->view('prose/all_report',$otherPage);
                        break;
                        ...
                        break;
                        case 'statistics':
                            $this->load->view('prose/statistics_report',$otherPage);
                        break;
                        case 'statistics2':
                            $this->load->view('prose/statistics2_report',$otherPage);
                        break;
                        case 'evaluators':
                            $this->load->view('prose/evaluators_report',$otherPage);
                        break;
                        case 'voting_graph':
                            $this->load->view('prose/voating_report',$otherPage);
                        break;
            ...
            <div class="col-md-3 mobile-col-3">
                <div class="row form-row ws-form-row m-0" style="display: block !important;">
                    <div class="full-left noFooter">
                        ...
                        <hr class="admin-link"> -->
                        <a href="<?php echo base_url()?>prose/reports"><p style="font-size: 16px;" class="p1">Reports <i class='bx bxs-chevron-right'></i></a></p>
                    </div>
                </div>
