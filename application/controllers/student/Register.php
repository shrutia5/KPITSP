...
class Register extends CI_Controller {
    ...
    public function verifyuser()
    {
        ...
        if($this->form_validation->run() == true){
            ...
            // if($checkLogin['verify_email'] == "no"){
            //     $status['msg'] = 'Please verify your email before logging in'; 
    ...
    public function registerUser()
	{
        ...
        $userData['countryCode'] = $this->validatedata->validate('countryCode','countryCode',true,'',array());
