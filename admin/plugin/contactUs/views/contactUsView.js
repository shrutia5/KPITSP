...
define([
  ...
  'backbone',
  'datepicker',
  '../views/contactUsSingleView',
  '../collections/contactUsCollection',
  '../models/contactUsFilterOptionModel',
  'text!../templates/contactUsRow.html',
  'text!../templates/contactUsTemp.html',
  'text!../templates/contactUsFilterOptionTemp.html',
], function($,_, Backbone,datepicker,contactUsSingleView,contactUsCollection,contactUsFilterOptionModel,contactUsRowTemp,contactUsTemp,contactUsFilterTemp){
...
var contactUsView = Backbone.View.extend({
    ...
    initialize: function(options){
        ...
        readyState = true;
        this.render();
        filterOption = new contactUsFilterOptionModel();
    ...
    loadSubView:function(e){
        ...
        switch(show)
        {
          case "singlecontactUsData":{
            var contactUsID = $(e.currentTarget).attr("data-contactUsID");
            var contactUsSingleview = new contactUsSingleView({contactUsID:contactUsID,searchcontactUs:this});
            break;
          }
        }
    },
    resetSearch: function()
    {
        ...
        filterOption.set({curpage:0,contactUsID:null,textval: null,textSearch:'contactUsID',status:'active,inactive',orderBy:'contactUsID',order:'ASC'});
    ...
    addOne: function(objectModel){
        ...
        $("#faqList").append(template({contactUsDetails:objectModel}));
    },
    addAll: function(){
        $("#faqList").empty();
    ...
    filterRender:function(){
      ...
      if($('#filterData').length){
        ...
        var template = _.template(contactUsFilterTemp);
