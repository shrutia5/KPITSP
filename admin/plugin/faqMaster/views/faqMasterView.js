...
define([
  ...
  'backbone',
  'datepicker',
  '../views/faqMasterSingleView',
  '../collections/faqMasterCollection',
  '../models/faqMasterFilterOptionModel',
  'text!../templates/faqMasterRow.html',
  'text!../templates/faqMasterTemp.html',
  'text!../templates/faqMasterFilterOptionTemp.html',
], function($,_, Backbone,datepicker,faqMasterSingleView,faqMasterCollection,faqMasterFilterOptionModel,faqMasterRowTemp,faqMasterTemp,faqMasterFilterTemp){
...
var faqMasterView = Backbone.View.extend({
    ...
    initialize: function(options){
        ...
        readyState = true;
        this.render();
        filterOption = new faqMasterFilterOptionModel();
        searchfaqMaster = new faqMasterCollection();
        searchfaqMaster.fetch({headers: {
      ...
      this.collection = searchfaqMaster;
    ...
    changeStatusListElement:function(e){
      ...
      $('#faqList input:checkbox').each(function(){
          if($(this).is(":checked"))
          {
            removeIds.push($(this).attr("data-faqID"));
          }
      });
    ...
    loadSubView:function(e){
        ...
        switch(show)
        {
          case "singlefaqMasterData":{
            var faqID = $(e.currentTarget).attr("data-faqID");
            var faqMasterSingleview = new faqMasterSingleView({faqID:faqID,searchfaqMaster:this});
            break;
          }
        }
    },
    resetSearch: function()
    {
        ...
        filterOption.set({curpage:0,faqID:null,textval: null,textSearch:'faqID',status:'active,inactive',orderBy:'faqID',order:'ASC'});
    ...
    addOne: function(objectModel){
        var template = _.template(faqMasterRowTemp);
        $("#faqList").append(template({faqMasterDetails:objectModel}));
    },
    addAll: function(){
        $("#faqList").empty();
    ...
    filterRender:function(){
      ...
      if($('#filterData').length){
        ...
        var template = _.template(faqMasterFilterTemp);
    ...
    render: function(){
        var template = _.template(faqMasterTemp);
