...
define([
  ...
  'backbone',
  'datepicker',
  '../views/blogsSingleView',
  '../collections/blogsCollection',
  '../models/blogsFilterOptionModel',
  'text!../templates/blogsRow.html',
  'text!../templates/blogsTemp.html',
  'text!../templates/blogsFilterOptionTemp.html',
], function($,_, Backbone,datepicker,blogsSingleView,blogsCollection,blogsFilterOptionModel,blogsRowTemp,blogsTemp,blogsFilterTemp){
...
var blogsView = Backbone.View.extend({
    ...
    initialize: function(options){
        ...
        readyState = true;
        this.render();
        filterOption = new blogsFilterOptionModel();
        searchblogs = new blogsCollection();
        searchblogs.fetch({headers: {
    ...
    changeStatusListElement:function(e){
      ...
      $('#blogsList input:checkbox').each(function(){
          if($(this).is(":checked"))
          {
    ...
    loadSubView:function(e){
        ...
        switch(show)
        {
          case "singleblogsData":{
            var blogID = $(e.currentTarget).attr("data-blogID");
            var blogsSingleview = new blogsSingleView({blogID:blogID,searchblogs:this});
            break;
          }
        }
    },
    resetSearch: function()
    {
        ...
        filterOption.set({curpage:0,blogID:null,textval: null,textSearch:'blogTitle',status:'active',orderBy:'blogTitle',order:'ASC'});
        $(".multiOptionSel").removeClass("active");
        $("#textval").val("");
        $('#textSearch option[value=blogID]').attr('selected','selected');
        this.filterSearch();
    },
    loaduser:function(){
    ...
    addOne: function(objectModel){
        var template = _.template(blogsRowTemp);
        $("#blogsList").append(template({blogsDetails:objectModel}));
    },
    addAll: function(){
        $("#blogsList").empty();
    ...
    filterRender:function(){
      ...
      if($('#filterData').length){
        ...
        var template = _.template(blogsFilterTemp);
    ...
    render: function(){
        var template = _.template(blogsTemp);
