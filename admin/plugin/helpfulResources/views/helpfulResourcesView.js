...
define([
  ...
  'backbone',
  'datepicker',
  '../views/helpfulResourcesSingleView',
  '../collections/helpfulResourcesCollection',
  '../models/helpfulResourcesFilterOptionModel',
  'text!../templates/helpfulResourcesRow.html',
  'text!../templates/helpfulResourcesTemp.html',
  'text!../templates/helpfulResourcesFilterOptionTemp.html',
], function($,_, Backbone,datepicker,helpfulResourcesSingleView,helpfulResourcesCollection,helpfulResourcesFilterOptionModel,helpfulResourcesRowTemp,helpfulResourcesTemp,helpfulResourcesFilterTemp){
...
var helpfulResourcesView = Backbone.View.extend({
    ...
    initialize: function(options){
        ...
        readyState = true;
        this.render();
        filterOption = new helpfulResourcesFilterOptionModel();
        searchhelpfulResources = new helpfulResourcesCollection();
        searchhelpfulResources.fetch({headers: {
      ...
      this.collection = searchhelpfulResources;
    ...
    changeStatusListElement:function(e){
      ...
      $('#faqList input:checkbox').each(function(){
          if($(this).is(":checked"))
          {
            removeIds.push($(this).attr("data-resourceID"));
          }
      });
      ...
      if(idsToRemove == ''){
        ...
        $.ajax({
            url:APIPATH+'helpfulResources/status',
            method:'POST',
    ...
    loadSubView:function(e){
        ...
        switch(show)
        {
          case "singlehelpfulResourcesData":{
            var resourceID = $(e.currentTarget).attr("data-resourceID");
            var helpfulResourcesSingleview = new helpfulResourcesSingleView({resourceID:resourceID,searchhelpfulResources:this});
            break;
          }
        }
    },
    resetSearch: function()
    {
        ...
        filterOption.set({curpage:0,resourceID:null,textval: null,textSearch:'resourceID',status:'active',orderBy:'resourceID',order:'ASC'});
    ...
    addOne: function(objectModel){
        var template = _.template(helpfulResourcesRowTemp);
        $("#helpfulList").append(template({helpfulResourcesDetails:objectModel}));
    },
    addAll: function(){
        $("#helpfulList").empty();
    ...
    filterRender:function(){
      ...
      if($('#filterData').length){
        ...
        var template = _.template(helpfulResourcesFilterTemp);
    ...
    filterSearch: function(){
        $('#myModal').modal('hide');
        searchhelpfulResources.reset();
        var selfobj = this;
        readyState = true;
        filterOption.set({curpage: 0,status:'active'});
    ...
    render: function(){
        var template = _.template(helpfulResourcesTemp);
