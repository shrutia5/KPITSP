        ...
        if(getmsg != ""){
            $.ajax({
               ...
               success:function(res){
                 ...
                 if(res.flag == "S"){
                    var msg ='<div class="row"><div class="col-md-10 col-10 p-2"><div class="left-chat"><p class="msg-p p-2">'+getmsg+'</p></div><span class="time-txt">Today, '+res.msg+'</span></div><div class="col-md-2 col-2 p-0"><p class="right-txt">'+$("#sender_initials").val()+'</p></div></div>';
