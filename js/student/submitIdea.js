...
$(document).ready(function () {
  ...
  //$(".ideaSubmission").hide();
  //$(".section_1").show();
  if (currentStep == 1) $("#prevbtn").attr("disabled", "disabled");
        ...
        if (secID == numItems) {
          ...
          $(".file-required").each(function () {
            if (!$(this).hasClass("hide")) {
              $(this).append(
                '<p class="error file-error">Please upload this field</p>'
              );
              hasEmptyFile = true;
              return false;
            }
          ...
          success: function (res) {
            ...
            if (res.flag == "S") {
              ...
              if (secID <= numItems) {
                ...
                $("#nextbtn").attr("data-secID", secID);
                $(".submission-tab").removeClass("active");
                $("#" + $(".section_" + secID).attr("data-tab")).addClass(
                  "active"
                );
                $(".trl-page").scrollTop(0);
                $(".full-left").scrollTop(0);
        ...
        success: function (res) {
          if (res != "") {
            ...
            if (res.flag == "S") {
              ...
              $("#qdiv_" + questionID + " .RTU-uploadItemsList").attr(
                "data-upload",
                0
              );
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          if (res.flag == "S") {
            ...
            $("#qdiv_" + fileType + " .RTU-uploadItemsList").attr(
              "data-upload",
              0
            );
            ...
            if (fileType == "prototypeProgressVideo") {
              console.log(
                "D:" +
                  $("#qdiv_prototypeProgressVideo2 .file-input").hasClass(
                    "hide"
                  )
              );
              if (
                !$("#qdiv_prototypeProgressVideo2 .file-input").hasClass("hide")
              ) {
            ...
            if (fileType == "prototypeProgressVideo2") {
              if (
                !$("#qdiv_prototypeProgressVideo .file-input").hasClass("hide")
              ) {
                $("#qdiv_prototypeProgressVideo2").addClass("hide");
              }
            }
