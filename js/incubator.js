    ...
    $.ajax({
        ...
        success:function(res){
            ...
            if(res.flag == "F"){
                ...
                if(incubate == "Remove"){
                    alertify.confirm('', 'Are you sure want to add this project from the list of your selection?', function(){ 
                        $.ajax({
                            type: "POST",
                    ...
                    alertify.confirm('', 'Are you sure want to remove this project from the list of your selection?', function(){ 
                        $.ajax({
                            type: "POST",
                            url: base_url+"incubateAction",
                            data: {incubateAction:incubate,incubateId:incubateId},
