                ...
                },
                {
                  ...
                  value: function _readConfig(config) {
                    if (
                      ...
                      throw new Error(
                        "Config must contains a tutorials hash.\n" + this
                      );
                    }
                    for (var tutorialName in config) {
                      this.tutorials[tutorialName] = new _tutorial2.default(
                        config[tutorialName],
                        tutorialName,
                        this.delegate
                      );
      ...
      3: [
        function (require, module, exports) {
          ...
          if (
            ...
            navigator.userAgent.match(/msie|windows|firefox/i)
          ) {
            Node.prototype.getComputedCSSText = function () {
              ...
              for (var propertyName in computedStyle) {
                if (
                  "string" == typeof computedStyle[propertyName] &&
                  computedStyle[propertyName] != ""
                ) {
                  var translatedName =
                    cssTranslation[propertyName] || propertyName;
                  s[s.length] =
                    translatedName.replace(/[A-Z]/g, function (x) {
        ...
        function (require, module, exports) {
          ...
          var Overlay = (function () {
            ...
            function Overlay(config) {
              ...
              this.shouldOverlay =
                config.shouldOverlay === undefined
                  ? true
                  : config.shouldOverlay;
              this.overlayColor =
                config.overlayColor || "rgba(255,255,255,0.8)";
              this.useTransparentOverlayStrategy =
                !!config.useTransparentOverlayStrategy;
            ...
            _createClass(Overlay, [
              ...
              },
              {
                ...
                value: function showBackgroundOverlay() {
                  ...
                  this._resizeHandler =
                    this._resizeOverlayToFullScreen.bind(this);
                },
              ...
              },
              {
                ...
                value: function focusOnElement($element) {
                  ...
                  this._resizeHandler = this._resizeOverlayToElement.bind(
                    this,
                    $element
                  );
                },
              ...
              },
              {
                ...
                value: function _createOverlay() {
                  ...
                  $overlay.css({
                    "z-index": _constants2.default.OVERLAY_Z_INDEX,
                  });
                  return $overlay;
                },
              },
              {
                ...
                value: function _createTransparentOverlay() {
                  var $transparentOverlay = $(
                    "<div class='chariot-transparent-overlay'></div>"
                  );
        ...
        function (require, module, exports) {
          ...
          var Step = (function () {
            ...
            function Step() {
              ...
              if (!config.selectors) {
                throw new Error(
                  "selectors must be present in Step configuration\n" + this
                );
              } else if (typeof config.selectors === "string") {
                this.selectors = { 0: config.selectors };
              } else if (
                Object.prototype.toString.call(config.selectors) ===
                "[object Object]"
              ) {
                ...
                throw new Error(
                  "selectors must be an object, array, or string"
                );
              }
            ...
            _createClass(Step, [
                  ...
                  Promise.resolve()
                    .then(function () {
                      if (_this2.delegate.willBeginStep) {
                        return _this2.delegate.willBeginStep(
                          _this2,
                          _this2.index,
                          _this2.tutorial
                        );
                    ...
                    .then(function () {
                      if (_this2.delegate.willShowOverlay) {
                        return _this2.delegate.willShowOverlay(
                          _this2.overlay,
                          _this2.index,
                          _this2.tutorial
                        );
                    ...
                    .then(function () {
                      // Render the overlay
                      if (
                        _this2.overlay.isTransparentOverlayStrategy() &&
                        Object.keys(_this2.selectors).length === 1
                      ) {
                    ...
                    .then(function () {
                      if (_this2.delegate.didShowOverlay) {
                        return _this2.delegate.didShowOverlay(
                          _this2.overlay,
                          _this2.index,
                          _this2.tutorial
                        );
                    ...
                    .then(function () {
                      if (_this2.delegate.willRenderTooltip) {
                        return _this2.delegate.willRenderTooltip(
                          _this2.tooltip,
                          _this2.index,
                          _this2.tutorial
                        );
                    ...
                    .then(function () {
                      ...
                      if (_this2.delegate.didRenderTooltip) {
                        return _this2.delegate.didRenderTooltip(
                          _this2.tooltip,
                          _this2.index,
                          _this2.tutorial
                        );
                    ...
                    .then(function () {
                      ...
                      _this2._resizeHandler = (0, _lodash2.default)(
                        function () {
                          for (var selectorName in _this2.selectors) {
                            ...
                            if (elementInfo.clone) {
                              ...
                              _style2.default.clearCachedStylesForElement(
                                $element
                              );
                  ...
                  Promise.resolve()
                    .then(function () {
                      if (_this3.delegate.didFinishStep) {
                        return _this3.delegate.didFinishStep(
                          _this3,
                          _this3.index,
                          _this3.tutorial
                        );
              ...
              {
                key: "_waitForElement",
                value: function _waitForElement(
                  selectorName,
                  numAttempts,
                  resolve,
                  reject
                ...
                value: function _applyComputedStyles($clone, $element) {
                  ...
                  $element
                    ...
                    .forEach(function (child, index) {
                      _this8._applyComputedStyles(
                        $(clonedChildren[index]),
                        $(child)
                      );
                    });
                },
            ...
            _createClass(Style, null, [
              ...
              },
              {
                ...
                value: function _ieBoxModelStyleFix(style, $ele, cssText) {
                  ...
                  var value =
                    match && match.length > 1 ? parseInt(match[1]) : 0;
              ...
              },
              {
                ...
                value: function _clonePseudoStyle(
                  $element,
                  $clone,
                  pseudoClass
                ) {
        ...
        function (require, module, exports) {
          ...
          var Tooltip = (function () {
            ...
            function Tooltip(config, step, tutorial) {
              ...
              this.xOffsetTooltip = config.xOffsetTooltip
                ? parseInt(config.xOffsetTooltip)
                : 0;
              this.yOffsetTooltip = config.yOffsetTooltip
                ? parseInt(config.yOffsetTooltip)
                : 0;

              this.offsetArrow = config.offsetArrow
                ? parseInt(config.offsetArrow)
                : 0;
              ...
              if (selectorKeys.length > 1 && !config.anchorElement) {
                throw new Error(
                  "anchorElement is not optional when more than one " +
                    "selector exists:\n" +
                    this
                );
              }
            ...
            _createClass(Tooltip, [
              ...
              },
              {
                ...
                value: function _createTooltipTemplate() {
                  ...
                  var template =
                    ...
                    this._iconMarkup() +
                    '</div>\n        <h1 class="chariot-tooltip-header">' +
                    this.title +
                    '</h1>\n        <div class="chariot-tooltip-content"><p>' +
                    this.text +
              ...
              },
              {
                ...
                value: function _classNames() {
                  ...
                  var defaultClassNames =
                    "chariot-tooltip chariot-step-" + currentStep;
              ...
              },
              {
                ...
                value: function _iconMarkup() {
                  ...
                  return (
                    "<div class='chariot-tooltip-icon'>\n       <img class='chariot-tooltip-icon-img' src=\"" +
                    this.iconUrl +
                    '"/>\n     </div>'
                  );
                },
              },
              {
                ...
                value: function _subtextMarkup() {
                  ...
                  return (
                    "<span class='chariot-tooltip-subtext'>\n      " +
                    this.subtext(
                      this.currentStepNum(),
                      this.tutorial.steps.length
                    ) +
                    "\n    </span>"
                  );
                },
              },
              {
                ...
                value: function _arrowMarkup() {
                  ...
                  return (
                    '<div class="chariot-tooltip-arrow ' +
                    this.arrowClass +
                    '"></div>'
                  );
                },
              },
              {
                ...
                value: function _position($tooltip, $tooltipArrow) {
                  ...
                  if (
                    this.tutorial.animateScrolling &&
                    !this._isElementInViewport($tooltip)
                  ) {
                    $("html, body").animate(
                      {
                        scrollTop:
              ...
              },
              {
                ...
                value: function _positionTooltip($tooltip) {
                  ...
                  this.borderLeftWidth =
                    parseInt($tooltip.css("border-left-width")) || 0;
                  this.borderRightWidth =
                    parseInt($tooltip.css("border-right-width")) || 0;
                  this.borderBottomWidth =
                    parseInt($tooltip.css("border-bottom-width")) || 0;
                  this.borderTopWidth =
                    parseInt($tooltip.css("border-top-width")) || 0;
                  var top = _style2.default.calculateTop(
                    $tooltip,
                    $anchorElement,
                    this.yOffsetTooltip,
                    this.position,
                  ...
                  var left = _style2.default.calculateLeft(
                    $tooltip,
                    $anchorElement,
                    this.xOffsetTooltip,
                    this.position,
    ...
    */
              },
              {
                ...
                value: function _positionArrow($tooltip, $tooltipArrow) {
                  ...
                  var borderRadius =
                    parseInt($tooltip.css("border-radius")) || 0;

                  switch (this.arrowClass) {
                    case "chariot-tooltip-arrow-left":
                      top =
                        ($tooltip.outerHeight() - arrowDiagonal) / 2 -
                        this.yOffsetTooltip +
                        this.offsetArrow;
                      min = borderRadius;
                      max =
                        $tooltip.outerHeight() - arrowDiagonal - borderRadius;
                    ...
                    case "chariot-tooltip-arrow-bottom":
                      left =
                        ($tooltip.outerWidth() - arrowDiagonal) / 2 -
                        this.xOffsetTooltip +
                        this.offsetArrow;
                      min = borderRadius;
                      max =
                        $tooltip.outerWidth() - arrowDiagonal - borderRadius;
              ...
              },
              {
                ...
                value: function _getAnchorElement() {
                  ...
                  var clonedSelectedElement = this.step.getClonedElement(
                    this.anchorElement
                  );
                  ...
                  if ($element.length === 0) {
                    console.log(
                      "Anchor element not found: " + this.anchorElement
                    );
                  }
                  return $element;
                },
   ...
   */
            ...
            function Tutorial(config, name, delegate) {
              ...
              if (configType === "[object Array]") {
                ...
                this.useTransparentOverlayStrategy =
                  config.useTransparentOverlayStrategy;
                this.animateTooltips =
                  config.animateTooltips === undefined
                    ? true
                    : config.animateTooltips;
                this.animateScrolling =
                  config.animateScrolling === undefined
                    ? true
                    : config.animateScrolling;
                this.scrollAnimationDuration =
                  ...
                  if (step) {
                    if (typeof step === "number") {
                      if (step < 0 || step >= this.steps.length) {
                        throw new Error(
                          "step is outside bounds of steps array (length: " +
                            this.steps.length +
                            ")"
                        );
                      }
                  ...
                  return Promise.resolve()
                    .then(function () {
                      if (_this4.delegate.didFinishTutorial) {
                        return _this4.delegate.didFinishTutorial(
                          _this4,
                          forced
                        );
                      }
        ...
        { "./constants": 2, "./overlay": 4, "./step": 5, "es6-promise": 9 },
      ],
      9: [
        function (require, module, exports) {
    ...
    */
              ...
              lib$es6$promise$promise$$Promise._setAsap =
                lib$es6$promise$asap$$setAsap;
              lib$es6$promise$promise$$Promise._asap =
                lib$es6$promise$asap$$asap;
